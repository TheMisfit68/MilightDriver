...
//FIXME: - Not the actual V5 protocol, just a placholder

public struct MilightProtocolV5:MilightProtocol{
    
    public let protocolVersion:UInt8 = 5
